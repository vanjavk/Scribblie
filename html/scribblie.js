...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'html/scribblie.data';
    var REMOTE_PACKAGE_BASE = 'scribblie.data';
...
Module['FS_createPath']('/', 'assets', true, true);
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_html/scribblie.data');

    };
    Module['addRunDependency']('datafile_html/scribblie.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 253780, "filename": "/assets/FreeSans.ttf"}, {"start": 253780, "audio": 0, "end": 298521, "filename": "/assets/owl.png"}], "remote_package_size": 298521, "package_uuid": "4d937be8-37ba-4979-a099-855de7cffbb8"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5411632,
    DYNAMIC_BASE = 5411632,
    DYNAMICTOP_PTR = 168720;
...
var wasmBinaryFile = 'scribblie.wasm';
